...
There is something entirely new shown here: for most pairs of variables, larger X in the means for a species goes with larger Y. This is true for all pairs except for those involving `Sepal.Width`.
